    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white h-screen shadow-lg sticky top-0">
            <nav class="mt-6">
                ...
                <a href="../production/" class="flex items-center px-6 py-3 text-gray-700 bg-green-50 border-r-4 border-green-600">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="flex-1 p-8">
            <h2 class="text-3xl font-bold text-gray-800 mb-6">Production Management</h2>

            <!-- Top Actions -->
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-bold text-gray-800">Egg Production Records</h3>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-700">All Production Records</h3>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php foreach ($productions as $row): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo number_format($row['eggs_collected']); ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-red-600 font-medium">
                                            <?php echo $row['damaged_eggs']; ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo number_format($row['egg_weight_kg'], 2); ?>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-500">
                                            <?php echo htmlspecialchars($row['notes'] ?: '—'); ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="edit.php?id=<?php echo $row['production_id']; ?>" class="text-blue-600 hover:text-blue-900 transition">
                                                Edit
                                            </a>
                                        </td>
                                    </tr>
                ...
                <?php else: ?>
                    <div class="text-center py-12 text-gray-500">
                        ...
                        <p class="mt-4 text-lg">No production records found.</p>
