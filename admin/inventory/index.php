    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white h-screen shadow-lg sticky top-0">
            <nav class="mt-6">
                ...
                <a href="../inventory/" class="flex items-center px-6 py-3 text-gray-700 bg-green-50 border-r-4 border-green-600">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="flex-1 p-8">
            <h2 class="text-3xl font-bold text-gray-800 mb-6">Feed Inventory Management</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800 mt-2">₱<?php echo number_format($total_value, 2); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo $low_stock_count; ?></p>
                        </div>
                    ...
                    <?php if ($low_stock_count > 0): ?>
                        <p class="text-red-600 text-xs mt-2">⚠️ Some items need restocking</p>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Total Feed Types</p>
                            <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo $result->num_rows; ?></p>
                        </div>
            ...
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-bold text-gray-800">Feed Stock</h3>
                <div class="flex gap-3">
                    <a href="consumption.php" class="bg-purple-500 hover:bg-purple-600 text-white px-6 py-2 rounded-lg font-semibold transition">
                        View Consumption
                    </a>
                    <a href="update.php" class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-lg font-semibold transition">
                        Update Stock
                    </a>
                    <a href="add.php" id="openFeedModal" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold transition">
                        Add Feed Stock
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <?php echo htmlspecialchars($row['feed_type']); ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo number_format($row['quantity_kg'], 2); ?> kg
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ₱<?php echo number_format($row['quantity_kg'] * $row['unit_price'], 2); ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo htmlspecialchars($row['supplier'] ?? 'N/A'); ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo number_format($row['reorder_level'], 2); ?> kg
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="update.php?id=<?php echo $row['feed_id']; ?>" class="bg-orange-500 hover:bg-orange-600 text-white px-3 py-1 rounded text-sm transition">
                                            Update
                                        </a>
                                    </td>
                                </tr>
                ...
                <?php else: ?>
                    <div class="text-center py-12 text-gray-500">
                        ...
                        <p class="mt-4 text-lg">No feed inventory found.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
    ...
    <div id="feedModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-lg w-full max-w-3xl overflow-hidden">
            <div class="flex justify-between items-center border-b px-6 py-4">
                <h3 class="text-lg font-semibold text-gray-800">Add Feed Stock</h3>
                <button id="closeFeedModal" class="text-gray-500 hover:text-gray-700 text-2xl transition">&times;</button>
            </div>
