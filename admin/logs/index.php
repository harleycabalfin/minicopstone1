...
requireUser();
requireAdmin(); // Add admin check for system logs
    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white h-screen shadow-lg sticky top-0">
            <nav class="mt-6">
                ...
                <a href="../logs/" class="flex items-center px-6 py-3 text-gray-700 bg-green-50 border-r-4 border-green-600">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    System Logs
        ...
        <main class="flex-1 p-8">
            <h2 class="text-3xl font-bold text-gray-800 mb-6">System Logs</h2>

            <!-- Top Actions -->
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-bold text-gray-800">System Activity Logs</h3>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select name="user" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    ...
                    <div class="flex items-end">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold w-full transition">
                            Apply Filters
                        </button>
                    </div>
                </form>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <?php else: ?>
                    <div class="text-center py-12 text-gray-500">
                        ...
                        <p class="mt-4 text-lg">No logs found.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
